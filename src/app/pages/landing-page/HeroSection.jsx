...
const HeroSection = () => {
  return (
    <section
      id="hero"
      className="relative min-h-[90vh] flex items-center pt-32 pb-20 overflow-hidden bg-hero-glow"
    >
      {/* <!-- Background Elements --> */}
      ...
      <div className="max-w-360 mx-auto px-6 lg:px-12 relative z-10 w-full flex flex-col items-center text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mb-8">
          ...
          <span className="text-xs font-medium text-gray-300 tracking-wider uppercase">
            {" "}
            Taking on new projects in Nairobi and across Kenya
          </span>
        </div>
        ...
        <p className="text-lg md:text-xl text-gray-400 max-w-2xl mb-10 leading-relaxed">
          I build fast, conversion focused websites that help businesses in
          Kenya get more leads and customers.
        </p>

        <div className="flex flex-col sm:flex-row items-center gap-4 mb-16 w-full sm:w-auto">
          <a
            href="#"
            className="w-full sm:w-auto h-14 px-8 rounded-full bg-white text-black font-semibold text-base flex items-center justify-center hover:bg-gray-100 transition-colors"
          >
            Get a Free Website Review
          </a>
          <a
            href="#work"
            className="w-full sm:w-auto h-14 px-8 rounded-full border border-white/20 bg-white/5 text-white font-semibold text-base flex items-center justify-center hover:bg-white/10 transition-colors backdrop-blur-sm"
          >
            View My Work
          </a>
        </div>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-8 opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
            <a
              href="https://wisaguardsecurity.co.ke/"
              target="_blank"
              className="text-sm font-medium tracking-wide hover:text-white transition border-b border-transparent hover:border-white/40"
            >
              Wisaguard Security
            </a>
